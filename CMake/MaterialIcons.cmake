...
function(create_material_icon_theme)
    ...
    foreach (MAT_ICONS_ICON IN LISTS MAT_ICONS_CP_ICONS)
        ...
        if (NOT EXISTS "${MAT_ICONS_FILE_NAME}")
            ...
            message(STATUS "QtAppBase: Downloading icon '${MAT_ICONS_ICON}'")
            ...
            if (MAT_ICONS_DOWNL_ERROR)
                ...
                message(FATAL_ERROR "QtAppBase: Could not download icon '${MAT_ICONS_ICON}': ${MAT_ICONS_DOWNL_ERROR_MSG}")
            endif ()
        endif ()
